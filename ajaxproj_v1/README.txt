...
Application Title	 : ajaxproj_v1
Objective		 : Displays the ASCII value of the no entered by the user.
Technology Used		 : Ajax, Java, JSP, JavaScript, Servlet,Apache Ant
