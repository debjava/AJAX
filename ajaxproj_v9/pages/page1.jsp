...
<form name="theForm">
  <input type="radio" name="poem" onClick="retrieveURL('Poem1.do');">Langston Hughes - Dreams<br>
  <input type="radio" name="poem" onClick="retrieveURL('Poem2.do');">Walt Whitman - When I Heard The Learned Astronomer<br>
  <input type="radio" name="poem" onClick="retrieveURL('Poem3.do');">Robert Frost - The Road Not Taken<br>
