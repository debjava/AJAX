...
<html>
	...
	<body>
		<h1>An application in AJAX, which displays the ASCII value of the number entered by you.</h1>
		<h2>Developed by Debadatta Mishra</h2>
		<a href="mailTo:debadattamishra@aol.com">Debadatta Mishra</a>
		<table>
